...
import { ArtcileSortField, ArticleType, ArticleView } from '@/entities/Article';
...
export const getArticlesPageSort = (state:StateSchema) => state.articlePage?.sort ?? ArtcileSortField.CREATED;
